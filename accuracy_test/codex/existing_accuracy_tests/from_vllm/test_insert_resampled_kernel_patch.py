# Ascend A3 compatibility patch accuracy test.
# Ascend reuses the upstream kernel through its rejection_sampler_utils module.
...
# Reused kernel source: vllm/vllm/v1/worker/gpu/spec_decode/rejection_sampler_utils.py
...
try:
    ...
    pytest.skip(
        "installed vLLM-Ascend does not expose _insert_resampled_kernel; "
