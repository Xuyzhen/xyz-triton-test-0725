# Ascend A3 replacement-path accuracy patch.
# Upstream _fill_logprob_token_ids_kernel is replaced by tensor assembly in compute_topk_logprobs.
...
# Coverage mapping: _fill_logprob_token_ids_kernel -> compute_topk_logprobs token-ID assembly
