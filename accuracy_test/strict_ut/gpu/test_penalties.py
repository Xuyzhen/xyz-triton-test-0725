# GENERATED STRICT UT. Source: accuracy_test/codex/existing_accuracy_tests/from_vllm_ascend/test_penality.py
...
# Accuracy UT source: vllm-ascend-xyz/tests/e2e/nightly/single_node/ops/singlecard_ops/triton/test_penality.py
# Kernel source: vllm-ascend-xyz/vllm_ascend/worker/v2/sample/penalties.py
# Coverage: _penalties_kernel via apply_penalties
