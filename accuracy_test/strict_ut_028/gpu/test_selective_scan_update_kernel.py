...
# GPU counterpart of npu/test_selective_scan_update_kernel.py: identical
# shapes, dtypes, seeds and data generation for GPU-NPU comparison
# (double-benchmark per Precision Standard 2.1 sec 4.5: CPU reference is the
# Golden, GPU and NPU are both evaluated against it).
