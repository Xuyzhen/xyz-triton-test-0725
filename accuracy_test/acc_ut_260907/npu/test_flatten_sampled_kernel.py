# GENERATED STRICT UT. Source: accuracy_test/codex/existing_accuracy_tests/from_vllm/test_flatten_sampled_kernel.py
...
# Kernel source: vllm/vllm/v1/worker/gpu/spec_decode/rejection_sampler.py
# Coverage: _flatten_sampled_kernel
