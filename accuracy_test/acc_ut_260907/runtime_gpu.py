...
"""CUDA runtime helpers used by acc_ut_260907 GPU-side tests.

Mirrors strict_ut_027/runtime_gpu.py: device selection plus a no-op Triton
...
if not torch.cuda.is_available():
    pytest.skip(
        "CUDA is required for acc_ut_260907 GPU-side accuracy tests "
