...
class TestApplyGrammarBitmaskKernelPatch:
    ...
    def _run_kernel(self, logits, logits_indices, bitmask):
        ...
        # Call it through the patched vLLM module entry point, the same way
        # vllm_ascend/patch/worker/patch_v2/patch_triton.py does at runtime.
        import vllm.v1.worker.gpu.structured_outputs as structured_outputs
        try:
        ...
        # Apply the same runtime patch, then call the patched object.
