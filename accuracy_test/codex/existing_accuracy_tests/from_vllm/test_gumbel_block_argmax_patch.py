# Accuracy UT source: no direct Ascend helper UT; adapted from vllm/tests/v1/worker/test_gpu_gumbel_sample.py
# vLLM-Ascend patched kernel: _npu_gumbel_block_argmax from
# vllm-ascend-xyz/vllm_ascend/worker/v2/spec_decode/rejection_sampler_utils.py:34
