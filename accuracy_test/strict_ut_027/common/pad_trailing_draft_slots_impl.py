...
# strict_ut_027 shared dual-side UT for _pad_trailing_draft_slots_kernel.
...
# re-exported by gpu/test_pad_trailing_draft_slots_kernel.py and
# npu/test_pad_trailing_draft_slots_kernel.py. The side runtime (CUDA or
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (4, 16, 512, "partial_pad", 64),
        (4, 32, 1024, "no_pad", 128),
        (8, 32, 2048, "partial_pad", 256),
        (6, 16, 1024, "full_pad", 64),
        (2, 64, 4096, "partial_pad", 1024),  # max batch, production block
    ],
    ids=lambda v: str(v),
)
