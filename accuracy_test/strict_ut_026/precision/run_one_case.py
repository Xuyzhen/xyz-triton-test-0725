...
results/) so the whole strict_ut_026 directory travels as one unit.
"""
...
PREC_ROOT = Path(__file__).resolve().parent          # .../strict_ut_026/precision
SUITE_ROOT = PREC_ROOT.parent                        # .../strict_ut_026
