# GENERATED STRICT UT. Source: accuracy_test/codex/missing_accuracy_tests/test_resample_kernel_patch.py
...
# vllm-ascend/vllm_ascend/worker/v2/spec_decode/rejection_sampler_utils.py:82
