...
# easy_ut_026 strict UT for preprocess_mamba_align_fused_kernel.
...
def test_preprocess_mamba_align_fused(
    ...
    # inputs stay pristine for the NPU run.
    ref_inputs = {
    ...
    # NPU run: clone mutated tensors so we can compare against pristine CPU ref.
    npu_inputs = {
