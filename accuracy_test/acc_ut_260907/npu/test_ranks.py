# GENERATED STRICT UT. Source: accuracy_test/codex/existing_accuracy_tests/from_vllm_ascend/test_compute_topk_logprobs.py
...
# Accuracy UT source: vllm-ascend-xyz/tests/e2e/nightly/single_node/ops/singlecard_ops/triton/test_compute_topk_logprobs.py
# Kernel source: vllm-ascend-xyz/vllm_ascend/worker/v2/sample/logprob.py
# Coverage: _topk_log_softmax_kernel and _ranks_kernel via compute_topk_logprobs
